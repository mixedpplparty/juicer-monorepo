// Legacy zod schemas for this TypeScript server, which is kept only for
// drizzle migrations. The API types the client consumes are ts-rs generated
// in ../../../shared/src/types/generated (source of truth: server-rust).
