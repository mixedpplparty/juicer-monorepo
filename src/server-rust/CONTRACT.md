...
- search.rs: GET /all?query= (matches game name/tag/category plus Discord channel and role names — issue #40; returns TopicSearchResult items with resolved channel names and role assignment — issue #49, breaking response-shape change)
