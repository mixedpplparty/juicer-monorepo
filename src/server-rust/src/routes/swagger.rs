...
#[openapi(
    ...
    paths(
        ...
        crate::routes::games::get_associables,
        ...
        crate::routes::roles::get_role_settings,
...
mod tests {
    ...
    fn openapi_document_covers_routes_and_security() {
        ...
        for fragment in [
            ...
            "\"/discord/servers/{serverId}/roles/settings\"",
            "\"/discord/servers/{serverId}/games/associables\"",
            "\"TopicSearchResult\"",
            "\"RoleSettingsView\"",
            "\"AssociableOptions\"",
